...
urlpatterns = [
    ...
    path('cobros/<int:pk>/eliminar/', views.CobroDeleteView.as_view(), name='cobros_eliminar'),
    ...
    # Ingresos (antiguos "egresos" que en realidad eran cobros)
    path('ingresos/', views.IngresoListView.as_view(), name='ingresos_lista'),
    path('ingresos/crear/', views.IngresoCreateView.as_view(), name='ingresos_crear'),
    
    # Egresos reales (pagos a proveedores)
