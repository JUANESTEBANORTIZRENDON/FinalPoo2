...
class PerfilUsuario(models.Model):
    ...
    usuario = models.OneToOneField(
        User, on_delete=models.CASCADE, verbose_name="Usuario", related_name="perfil"
    )
    ...
    genero = models.CharField(
        max_length=1, choices=GENERO_CHOICES, blank=True, verbose_name="Género"
    )
    ...
    empresa = models.CharField(max_length=100, blank=True, verbose_name="Empresa")
    ...
    acepta_politica_privacidad = models.BooleanField(
        default=False, verbose_name="Acepta Política de Privacidad"
    )
